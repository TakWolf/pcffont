...
class PcfFontBuilder:
    ...
    def build(self) -> PcfFont:
        ...
        if accelerators.constant_metrics:
            ...
            accelerators.table_format.ink_metrics = True
            accelerators.ink_metrics = True
        else:
            ink_metrics = None

            accelerators.table_format.ink_metrics = False
        ...
        metrics.table_format.compressed_metrics = compressible
        if ink_metrics is not None:
            ink_metrics.table_format.compressed_metrics = compressible
